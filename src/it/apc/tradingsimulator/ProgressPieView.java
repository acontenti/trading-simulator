...
public class ProgressPieView extends View {
    ...
    public static final int MEDIUM_ANIMATION_SPEED = 10;
    ...
    private class AnimationRunnable implements Runnable {
        ...
        AnimationRunnable(int animateTo, int speed) {
        ...
        public void run() {
            if (getProgress() > mAnimateTo) {
                ...
                mProgressHandler.postDelayed(this, speed);
            } else {
    ...
    private class ProgressAnimationTask extends AsyncTask<Integer, Integer, Void> {
